...
-- CreateIndex
CREATE UNIQUE INDEX "user_recommendations_userId_recommendedId_key" ON "user_recommendations"("userId", "recommendedId");
...
-- AddForeignKey
ALTER TABLE "user_recommendations" ADD CONSTRAINT "user_recommendations_recommendedId_fkey" FOREIGN KEY ("recommendedId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
